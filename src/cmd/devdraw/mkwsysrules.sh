...
if [ $WSYSTYPE = x11 ]; then
	...
	echo 'WSYSOFILES=$WSYSOFILES xdg-pointer-constraints-protocol.o xdg-decoration-protocol.o xdg-shell-protocol.o wl-util.o wl-cb.o wl-draw.o wl-screen.o'
	echo 'WSYSHFILES=xdg-shell-protocol.h xdg-pointer-constraints-protocol.h xdg-decoration-protocol.h wl-inc.h'
